...
contract ProductShards is Ownable, Pausable, ERC1155 {
    ...
    */
    event InitialShardDistributed(
        uint productUID, address[] dataOwners, 
        uint[] shardAmount
    );
...
//---------------------------------  EXTERNAL --------------------------------------------//    
    ...
    */
    function distributeInitialShards(
        ...
        whenNotPaused
    {
       _distributeInitialShards(_productUID, _targetSupply, _labCredit, _lockPeriod, _initialPercent, _rejuvePercent, _lab, _rejuve, _uris);
    }
...
//---------------------------------------- PRIVATE ---------------------------------------------//
    ...
    */
        ...
        private 
    {
        ...
        require(_initialPercent != 0, "REJUVE: Initial contributors percent cannot be 0");
    ...
    */
    function _mintInitialShards(
        ...
        private
    {
        bytes[] memory productDataHashes = _productNFT.getProductToData(_productUID);
